...
function TechsolutionsPro() {
  ...
  const makePayment = () => {
    ...
    const options = {
      ...
      name: "TechSolutions Academy",
      description: "TechSolutions Pro Membership",
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
          ...
          >
            ...
            {!isMember ? (
              <button
                onClick={() =>
                  createSubscription(process.env.NEXT_PUBLIC_MONTHLY_PLAN)
                }
          ...
          >
            ...
            <button
              onClick={() =>
                createSubscription(process.env.NEXT_PUBLIC_YEARLY_PLAN)
              }
      ...
      <p className="text-center">
        ...
        <strong>TECH SOLUTIONS</strong> (monthly plan only).
      </p>
    </div>
  );
}

export default TechsolutionsPro;
